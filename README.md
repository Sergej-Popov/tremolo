...
- Add code blocks with syntax highlighting and line numbers using the </> button or **c** shortcut. A dropdown lets you choose language and font size. Highlight.js is bundled for offline use.
