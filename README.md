...
- Add code blocks with syntax highlighting and line numbers using the </> button or **c** shortcut. A dropdown lets you choose language and font size. Syntax highlighting is powered by Shiki.
